    ...
    return (
        <>
            <div className="bg-[whitesmoke] flex flex-col justify-center items-center py-[10rem]">
                <div className="flex justify-start items-center w-[95vw] gap-10 mb-10 text-sm">
                    <span className="cursor-pointer  w-24">
                        <h2
                            onClick={() => set_formState("참가자")}
                            className={cls(
                                "text-center mb-1 transition",
                                formState === "참가자" ? "font-bold text-red-800 scale-[1.02]" : "font-normal mb-1"
                            )}
                        >참가자</h2>
                        {formState === "참가자" &&
                            <motion.hr
                    ...
                    <span className="cursor-pointer w-24">
                        <h2
                            ...
                            className={cls(
                                "text-center mb-1 transition",
                                formState === "공지" ? "font-bold text-red-800 scale-[1.02]" : "font-normal mb-1"
                            )}
                        >공지</h2>
                        {formState === "공지" &&
                            <motion.hr
